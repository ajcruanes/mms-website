      ...
      <div className="footer-body">
        <div className="container">
          <div className="footer-grid">
            <div className="footer-brand">
              ...
              <a href="https://www.instagram.com/mmssince1994/" target="_blank" rel="noopener noreferrer" className="social-btn">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg> @mmssince1994
              </a>
              </div>
            </div>
          ...
          <div className="footer-bottom">
            <p>© 2026 Metropolitan Mountaineering Society. All rights reserved.</p>
            <p className="footer-instagram">
              Follow us on Instagram{' '}
              <a href="https://www.instagram.com/mmssince1994/" target="_blank" rel="noopener noreferrer">
                @mmssince1994
              </a>
            </p>
